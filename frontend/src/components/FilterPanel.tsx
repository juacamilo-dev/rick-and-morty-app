    ...
    <div className="flex flex-col gap-5">
      ...
      <div className="flex gap-2">
        <button
          type="button"
          onClick={onClear}
          className="flex-1 rounded-lg border border-gray-200 px-4 py-2 text-sm font-medium text-gray-600 transition-colors hover:bg-gray-50 active:bg-gray-100"
        >
          Clear filters
        </button>
        <button
          type="button"
          onClick={onApply}
          className="flex-1 rounded-lg bg-gray-200 px-4 py-2 text-sm font-medium text-gray-700 transition-colors hover:bg-purple-200 active:bg-purple-600 active:text-white"
        >
          Filter
        </button>
      </div>
...
function FilterPanel(props: FilterPanelProps) {
  ...
  return (
    <div ref={panelRef} className="contents">
      ...
      <div className="absolute right-0 top-full z-20 mt-2 hidden w-80 rounded-lg border border-gray-200 bg-white p-4 shadow-lg md:block">
